...
@Service
public class AmountCalculatorService implements AmountCalculator {
    ...
    public AmountCalculatorService(final @Qualifier("resultMathContext") MathContext resultMathContext,
